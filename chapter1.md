...
ex() %>% check_function("plot") %>% check_arg("x") %>% check_equal(incorrect_msg="Use the density function to plot the density of logclaims.")
...
ex() %>% check_function("hist",index=2) %>% check_arg("x"0 %>% check_equal()
